        ...
        public static string Derivative(string func)
        {
            ...
            for (int i = 0; i < postfixList.Length; i++)
            {
                ...
                else if (unaryOperators.Any(token.Contains))
                {
                    ...
                    //Create string of the rest of the array
                    for (int j = i + 1; j < postfixList.Length; j++)
                    {
                        A += postfixList[j];
                    }
